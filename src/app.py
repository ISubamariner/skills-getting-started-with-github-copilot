...
activities = {
    ...
    # Artistic activities
    "Art Club": {
        "description": "Explore various art forms like drawing, painting, and sculpting",
    ...
    "Debate Team": {
        "description": "Improve public speaking and critical thinking through debates",
        "schedule": "Thursdays, 3:00 PM - 4:30 PM",
        "max_participants": 10,
        "participants": []
    },
    "Science Fair Club": {
        "description": "Conduct experiments and prepare projects for the annual science fair",
